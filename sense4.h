/**************************************************************************************
* Copyright (c) 2011, Beijing SenseLock Info. & Secu. Inc.
* All rights reserved.
*
* filename: sense4.h
*
* brief: EliteIV Net library interface declaration, return value and some constant definition.
*
* date:        26/01/2011
*******************************************************************************************/
#ifndef __SENSE4_H__
...
#define S4_GET_LICENSE							0x00000020						/** get license */
#define S4_FREE_LICENSE							0x00000021						/** free license */
#define S4_MODIFY_TIMOUT						0x00000022						/** change the timeout value */
	//@}
...
#define S4_MODULE_NOT_FOUND						0x00000301						/** the specified module can't be found*/
#define S4_LICENSE_EXIST						0x00000302						/** license already existed*/
#define S4_USER_NOT_FOUND						0x00000303						/** can't find any user*/
#define S4_LICENSE_INVALID						0x00000304						/** invalid license*/
#define S4_TIMEOUT								0x00000305						/** communication overtime*/
#define S4_NETWORK_ERROR						0x00000306						/** communication data error*/
#define S4_LICENSE_NOT_FOUND					0x00000307						/** can't find any valid license*/
#define S4_EXECUTE_ERROR						0x00000308						/** execute error*/
#define S4_TOTALLICENSE_BEYOND					0x00000309						/** exceeding the total license count*/
#define S4_MODULELICENSE_BEYOND					0x00000310						/** exceeding the module license count*/
#define S4_DEVICE_INVALID						0x00000311						/** invalid device*/
#define S4_USERPIN_ERROR						0x00000312						/** verify the user pin error*/
#define S4_MODULE_ZERO							0x00000313						/** module count is 0*/
#define S4_DEVICETYPE_ERROR						0x00000314						/** invalid device type*/
#define S4_DEVICE_START_FAILED					0x00000315						/** startup device error*/
#define S4_DEVICE_STOP_FAILED					0x00000316						/** stop device error*/
#define S4_FREELICE_RETERROR                    0x00000321                      /** device return error when free license*/
#define S4_NET_TIMEOUT							0x00000324						/** net communication overtime*/
//@}
...
#define S4_USER_PIN_LEN							8								/** user pin length*/
#define FILE_ID_LEN								4								/** file id length*/
//@}
...
#define _TM_DEFINED
	...
	*/
	typedef struct {
		unsigned int            dwIndex;                                        /** device index; index begins at zero*/
		unsigned int            dwVersion;                                      /** device version*/
		unsigned int			hLock;                                          /** device handle*/
		BYTE                    reserve[12];                                    /** reserved*/
		BYTE                    bAtr[MAX_ATR_LEN];                              /** ATR*/
		BYTE                    bID[MAX_ID_LEN];                                /** device ID*/
		unsigned int            dwAtrLen;                                       /** ATR length*/
	...
	typedef struct _S4NETCONFIG {
		...
		S4MODULEINFO  ModuleInfo[64];                                                   /* Module detail infomation */
	} S4NETCONFIG;
	...
	*/
	...
	/**
					set client INI file "e4ncli.ini" .

					@paramter lpszFilePath			[in]			ini file full name

					@return value

					if the function succeeds,the return value is S4_SUCCESS, otherwise return other defined return value.
	*/
	DWORD WINAPI S4SetIniPath(
		LPCSTR lpszFilePath
	);
